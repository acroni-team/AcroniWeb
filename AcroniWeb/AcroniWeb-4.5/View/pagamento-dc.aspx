<%@ Page Title="" Language="C#" MasterPageFile="~/View/logado.Master" AutoEventWireup="true" CodeBehind="pagamento-dc.aspx.cs" Inherits="AcroniWeb_4._5.pagamento_dc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right right-logado right-pagamento-cc" ng-app="">
        <div class="cabecalho cabecalho-cc">
            ...
            <img alt="Cartões de credito" src="../assets/img/pagamento/dc.png" />
        </div>

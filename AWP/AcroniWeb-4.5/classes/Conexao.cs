...
namespace acroni.classes
{
    class Conexao
    {
        ...
        internal static SqlConnection conexao = new SqlConnection("Data Source = " + Environment.MachineName + "; Initial Catalog = ACRONI_SQL; User ID = Acroni; Password = acroni7");

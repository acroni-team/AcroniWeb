                                ...
                                <div class="modal-overflow overflow-loja">
                                    <div class="modal-body modal-body-loja">
                                        ...
                                        <div class="left-loja">
                                            ...
                                            <asp:TextBox ID="txtFrete" class="textbox focus" runat="server" placeholder="Digite o frete" data-idProduto='<%# Eval("id_produto") %>' data-precoBase='<%# Eval("preco") %>'></asp:TextBox>

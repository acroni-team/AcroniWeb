<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TrocaPaginas.index" %>
    ...
    <body>
        <form id="form1" runat="server">
            <div id="main" class="m-div">
                <div class="light light--faderight" >
                    <a class="link" href="dark.aspx">alo</a>
                </div>    
                <div class="dark"></div>
